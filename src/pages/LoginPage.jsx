...
export default function LoginPage() {
  ...
  const handleSubmit = async (ev) => {
    ...
    try {
      ...
      setServerErr(ERR[err.code] || 'Sign-in failed. Please try again.');
  ...
  const handleGoogle = async () => {
    ...
    try {
      ...
      setServerErr(ERR[err.code] || 'Google sign-in failed.');
    ...
    <div className="auth-page">
      <div className="auth-card">
        ...
        <form className="auth-form" onSubmit={handleSubmit} noValidate>
          ...
          <div className="form-group">
            ...
            <input id="password" name="password" type="password" className={`form-input${errors.password?' error':''}`}
              placeholder="••••••••" value={form.password} onChange={onChange} disabled={loading || gLoading} autoComplete="current-password" />
            {errors.password && <p className="form-error">{errors.password}</p>}
          </div>

          <button className="btn btn-primary btn-lg btn-full" type="submit" disabled={loading || gLoading} id="signin-btn">
        ...
        <button className="btn btn-secondary btn-lg btn-full" type="button" onClick={handleGoogle}
          disabled={loading || gLoading} id="google-signin-btn">
